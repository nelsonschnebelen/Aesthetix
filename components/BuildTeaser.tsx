...
export function BuildTeaser() {
  return (
    <section className="relative overflow-hidden bg-char py-16 md:py-24">
      ...
      <div className="relative mx-auto max-w-[1280px] px-6 md:px-10">
        ...
        <p className="mt-6 band-copy text-bone/60">
        ...
        <Link
          href="/build"
          className="label-tech btn mt-8 inline-flex items-center gap-3 bg-gold text-char transition-colors hover:bg-bone"
        >
