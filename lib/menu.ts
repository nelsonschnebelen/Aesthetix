...
export type Category = "smash" | "notbeef" | "sides" | "shakes" | "brew";
...
export const CATEGORIES: { id: Category; label: string; note: string }[] = [
  ...
  { id: "sides", label: "Tots & Fries", note: "Fried twice, salted once." },
...
export const MENU: MenuItem[] = [
  ...
  {
    id: "classic-single",
    name: "The Classic Single",
    category: "smash",
    price: 995,
    blurb: "One patty, all crust. Proof that restraint is a flavour.",
    build: [
      "Toasted brioche crown",
      "Handcraft sauce",
      "Vine tomato",
  ...
  },
  {
    ...
    category: "sides",
    price: 525,
    blurb: "Cut at 4pm for tomorrow. Blanched, rested overnight, fried to order.",
    build: ["Idaho russet", "Twice fried", "Sea salt"],
    heat: 0,
    image: IMG.fries,
